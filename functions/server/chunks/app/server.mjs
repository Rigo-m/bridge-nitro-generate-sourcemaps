...
const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(defu);
...
const require$$24 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_weakMap_deleteAll);

const require$$25 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_deleteAll);

const require$$26 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_every);

const require$$27 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_filter);

const require$$28 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_find);

const require$$29 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_findKey);

const require$$30 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_includes);

const require$$31 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_keyOf);

const require$$32 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_mapKeys);

const require$$33 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_mapValues);

const require$$34 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_merge);

const require$$35 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_reduce);

const require$$36 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_some);

const require$$37 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(esnext_map_update);

const require$$38 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(deepmerge);
...
/******/ 					import('../_dynamic-require.mjs').then(m => m.default || m).then(dynamicRequire => dynamicRequire( ({"1":"components/nuxt-logo","2":"components/test1","3":"components/test2","4":"components/tutorial","5":"pages/_slug","6":"pages/index"}[chunkId]||chunkId) + ".js")).then(chunk => {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "f", function() { return /* reexport */ setNuxtAppInstance; });
__webpack_require__.d(__webpack_exports__, "a", function() { return /* reexport */ callWithNuxt; });
__webpack_require__.d(__webpack_exports__, "c", function() { return /* reexport */ defineNuxtPlugin; });
__webpack_require__.d(__webpack_exports__, "g", function() { return /* reexport */ useNuxtApp; });
__webpack_require__.d(__webpack_exports__, "b", function() { return /* reexport */ vue_composition_api["b" /* computed */]; });
__webpack_require__.d(__webpack_exports__, "d", function() { return /* reexport */ vue_composition_api["A" /* onMounted */]; });
__webpack_require__.d(__webpack_exports__, "e", function() { return /* reexport */ vue_composition_api["J" /* ref */]; });
__webpack_require__.d(__webpack_exports__, "h", function() { return /* reexport */ useState; });

// UNUSED EXPORTS: isVue2, isVue3, defineNuxtComponent, useLazyAsyncData, useLazyFetch, useCookie, useRequestHeaders, EffectScope, createApp, createRef, customRef, defineAsyncComponent, defineComponent, del, effectScope, getCurrentInstance, getCurrentScope, h, inject, isRaw, isReactive, isReadonly, isRef, markRaw, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onScopeDispose, onServerPrefetch, onUnmounted, onUpdated, provide, proxyRefs, reactive, readonly, set, shallowReactive, shallowReadonly, shallowRef, toRaw, toRef, toRefs, triggerRef, unref, useAttrs, useCSSModule, useCssModule, useSlots, version, warn, watch, watchEffect, watchPostEffect, watchSyncEffect, useAsyncData, useFetch, useHydration, useRuntimeConfig, useRouter, useRoute, useNuxt2Meta, addRouteMiddleware, navigateTo, abortNavigation, defineNuxtRouteMiddleware
...
var deepmerge = _interopDefault(__webpack_require__(53));
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_app__WEBPACK_IMPORTED_MODULE_2__[/* defineNuxtPlugin */ "c"])(nuxtApp => {
...
var nuxt_middleware = __webpack_require__(6);
...
const _2b8de0d3 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 6).then(__webpack_require__.bind(null, 74)));

const _29d73f8b = () => interopDefault(__webpack_require__.e(/* import() | pages/_slug */ 5).then(__webpack_require__.bind(null, 75)));
...
const NuxtLogo = () => __webpack_require__.e(/* import() | components/nuxt-logo */ 1).then(__webpack_require__.bind(null, 76)).then(c => wrapFunctional(c.default || c));
const Test1 = () => __webpack_require__.e(/* import() | components/test1 */ 2).then(__webpack_require__.bind(null, 65)).then(c => wrapFunctional(c.default || c));
const Test2 = () => __webpack_require__.e(/* import() | components/test2 */ 3).then(__webpack_require__.bind(null, 66)).then(c => wrapFunctional(c.default || c));
...
/* harmony default export */ var runtime_app_plugin_04ecf7a7 = (async (ctx, inject) => {
  const nuxtApp = {
    vueApp: {
  ...
  const middleware = await Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 6)).then(r => r.default);
  ...
  Object(runtime["f" /* setNuxtAppInstance */])(proxiedApp);
...
/* harmony default export */ var nuxt_axios = ((ctx, inject) => {
  ...
  const baseURL =  runtimeConfig.baseURL || runtimeConfig.baseUrl || process.env._AXIOS_BASE_URL_ || 'http://localhost:3000/'; // Create fresh objects for all default header scopes
...
/* harmony default export */ var capi_plugin = (Object(runtime["c" /* defineNuxtPlugin */])(nuxtApp => {
  const _originalSetup = nuxtApp.nuxt2Context.app.setup;
...
/* harmony default export */ var nitro_bridge_server = (Object(runtime["c" /* defineNuxtPlugin */])(nuxtApp => {
...
/* harmony default export */ var connectors = (Object(runtime["c" /* defineNuxtPlugin */])(nuxtApp => {
...
/* Plugins */
 ...
 // Source: ./runtime.app.plugin.04ecf7a7.mjs (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof runtime_app_plugin_04ecf7a7 === 'function') {
    await runtime_app_plugin_04ecf7a7(app.context, inject);
  }
